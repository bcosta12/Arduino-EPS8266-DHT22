...
#define SSID        "nameOfWifi" //your wifi network name
#define PASSWORD    "pass" //yout password
#define HOST_NAME   "10.0.0.2" //ip of the server, must be the same of the python udp server (or other that you prefer)
